...
function janrainCaptureWidgetOnLoad() {
    ...
    janrain.events.onCaptureLoginSuccess.addHandler(function(result){
        ...
        // $("#captureProfileLink").attr("href", "/enterprise/profile?ext=bv")
        ...
        // for this demo, we're only invoking BV for "social accounts"
        if (result.action == "socialSignin") {
            setBadgevillePlayerAfterAuthentication(result);
            showBVShowcase();
        }
    ...
    janrain.events.onCaptureRegistrationSuccess.addHandler(function(result){
        ...
        if (result.action == "socialRegister") {
    ...
    janrain.events.onCaptureSessionFound.addHandler(function(result){
        ...
        if (localStorage.getItem("janrainLastAuthMethod") == "socialSignin") {
            setBadgevillePlayerAfterAuthentication(result);
            showBVShowcase();
        }
    ...
    // unlike the other Enterprise demos, we use a more full-fledged session-end function to
    // keep the user on the same page, and show the behavior of also logging out of the BV widget.
