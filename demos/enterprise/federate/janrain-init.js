...
(function() {
    ...
    // janrain.settings.capture.federateServer = 'https://se-demo-federate.janrainsso.com';
...
function janrainCaptureWidgetOnLoad() {
    ...
    janrain.events.onCaptureLoginSuccess.addHandler(function(result){
        ...
        console.log ("onCaptureLoginSuccess called: data: ");
    ...
    janrain.events.onCaptureRegistrationSuccess.addHandler(function(result){
        janrain.capture.ui.modal.close();
        console.log ("onCaptureRegistrationSuccess called: data: ");
        if (window.console && window.console.log) console.log(result);
    ...
    janrain.events.onCaptureSessionFound.addHandler(function(result){
        console.log ("onCaptureSessionFound called: data: ");
        if (window.console && window.console.log) console.log(result);
        document.getElementById("captureSignInLink").style.display='none';
        document.getElementById("captureSignOutLink").style.display='';
        document.getElementById("captureProfileLink").style.display='';
    ...
    //////////////////////////////////////////////////////////////////////////////
    // NOTE - you should also implement the SSO functions for SSO-enabled sites.
    janrain.events.onCaptureFederateLogin.addHandler(function(result){
        console.log ("onCaptureFederateLogin called: data: ");
        console.log (result);
        document.getElementById("captureSignInLink").style.display='none';
        document.getElementById("captureSignOutLink").style.display='';
        document.getElementById("captureProfileLink").style.display='';
    });
    janrain.events.onCaptureFederateRefreshedToken.addHandler(function(result){
        console.log ("onCaptureFederateRefreshedToken called: data: ");
        console.log (result);
        document.getElementById("captureSignInLink").style.display='none';
        document.getElementById("captureSignOutLink").style.display='';
        document.getElementById("captureProfileLink").style.display='';
    ...
    janrain.events.onCaptureFederateNoLogin.addHandler(function(result){
        console.log ("onCaptureFederateNoLogin called: data: ");
        console.log (result);
    ...
    janrain.events.onCaptureAccessDenied.addHandler(function(result) {
        console.log ("onCaptureAccessDenied called: data: ");
        console.log (result);
        window.location = '/';
    });

    janrain.events.onCaptureExpiredToken.addHandler(function(result) {
        console.log ("onCaptureExpiredToken called: data: ");
        console.log (result);
        window.location = '/';
    });

    janrain.events.onCaptureSessionEnded.addHandler(function(result) {
        console.log ("onCaptureSessionEnded called: data: ");
        console.log (result);
        document.getElementById("captureSignInLink").style.display='';
        document.getElementById("captureSignOutLink").style.display='none';
        document.getElementById("captureProfileLink").style.display='none';
