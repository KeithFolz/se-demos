...
function janrainCaptureWidgetOnLoad() {
    ...
    // Custom event handlers for adobe analytics
    ...
    janrain.events.onCaptureLoginSuccess.addHandler(function(result){
        ...
        var provider = "traditionalAccount";
        if (result.authProvider != null) {
            provider = result.authProvider;
        }
        var gender = "unknown";
        if (result.userData != null && result.userData.gender != null ) {
            gender = result.userData.gender;
        }
        submitOmnitureEvent('event1', provider, gender, 'onCaptureLoginSuccess');
    ...
    janrain.events.onCaptureRegistrationSuccess.addHandler(function(result){
        ...
        submitOmnitureEvent('event2', provider, gender, 'onCaptureRegistrationSuccess');
