...
(function() {
    ...
    janrain.settings.capture.captureServer = 'https://' + janrainCaptureServerDomain;
    janrain.settings.capture.appId         = JanrainAppId;
    janrain.settings.capture.clientId      = janrainClientId;

    // These are the URLs for your Engage app's load.js file, which is necessary
    // to load the Capture Widget.
    var httpLoadUrl  = janrainHttpLoadUrl;
    var httpsLoadUrl = janrainHttpsLoadUrl;
