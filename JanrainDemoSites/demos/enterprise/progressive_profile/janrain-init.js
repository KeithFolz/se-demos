...
function janrainCaptureWidgetOnLoad() {
    ...
    /*--
        ...
        needs. These event handlers are provided as an example.
                                                                            --*/
    janrain.events.onCaptureLoginSuccess.addHandler(implFuncs.initAfterLogin);
    janrain.events.onCaptureSessionFound.addHandler(implFuncs.initAfterLogin);
    janrain.events.onCaptureRegistrationSuccess.addHandler(implFuncs.initAfterLogin);
...
//    janrain.events.onCaptureRegistrationSuccess.addHandler(implFuncs.setNavigationForLoggedInUser);
    janrain.events.onCaptureSessionEnded.addHandler(implFuncs.logout);
...
function janrainExampleImplementationFunctions() {
    function initAfterLogin(result) {
        console.log('setting nav for logged in user....');
        setNavigationForLoggedInUser(result);
        console.log('enable progressive profile button');
        $('#progressiveProfileBtn').toggle(true);
    }
    function logout(result) {
        setNavigationForLoggedOutUser(result);
        $('#progressiveProfileBtn').toggle(false);
    }
